...
import com.wifisecure.wifisecure.R;
import com.wifisecure.wifisecure.openvpn.VpnStatus.ConnectionStatus;
...
import static com.wifisecure.wifisecure.openvpn.NetworkSpace.ipAddress;
import static com.wifisecure.wifisecure.openvpn.VpnStatus.ConnectionStatus.LEVEL_CONNECTED;
import static com.wifisecure.wifisecure.openvpn.VpnStatus.ConnectionStatus.LEVEL_CONNECTING_NO_SERVER_REPLY_YET;
import static com.wifisecure.wifisecure.openvpn.VpnStatus.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;

public class OpenVPNService extends VpnService implements VpnStatus.StateListener, Callback, VpnStatus.ByteCountListener {
    public static final String START_SERVICE = "com.wifisecure.wifisecure.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.wifisecure.wifisecure.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.wifisecure.wifisecure.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.wifisecure.wifisecure.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "com.wifisecure.wifisecure.PAUSE_VPN";
    private static final String RESUME_VPN = "com.wifisecure.wifisecure.RESUME_VPN";
    public static final String STUNNEL_PID = "com.wifisecure.wifisecure.STUNNEL_PID";
    ...
    private void showNotification(boolean lowpriority, long when, VpnStatus.ConnectionStatus status) {
        if (mProfile != null) {
            ...
            if (status == LEVEL_CONNECTED)
                nbuilder.setContentTitle("WiFi Secure ON and CONNECTED");
            else
                nbuilder.setContentTitle("WiFi Secure ON");
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.wifisecure.wifisecure.openvpn.OpenVPNThreadv3");
