...
void Java_com_wifisecure_wifisecure_openvpn_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_com_wifisecure_wifisecure_openvpn_NativeUtils_getNativeAPI(JNIEnv *env, jclass jo)
{
