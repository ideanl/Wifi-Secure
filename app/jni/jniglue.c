...
void Java_ideanlabib_com_wifisecure_openvpn_NativeUtils_jniclose(JNIEnv *env,jclass jo, jint fd)
{
	int ret = close(fd);
}
...
jstring Java_ideanlabib_com_wifisecure_openvpn_NativeUtils_getNativeAPI(JNIEnv *env, jclass jo)
{
